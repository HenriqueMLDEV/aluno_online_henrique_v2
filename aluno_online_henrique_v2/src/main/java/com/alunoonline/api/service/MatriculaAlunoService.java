...
import com.alunoonline.api.model.dataTransferObject.NotasAtualizarRequestDto;
import com.alunoonline.api.model.dataTransferObject.DisciplinaAlunoDto;
import com.alunoonline.api.model.dataTransferObject.HistoricoAlunoDto;
...
public class MatriculaAlunoService {
    ...
    public void updateGrades(NotasAtualizarRequestDto atualizarNotasRequestDto, Long matriculaAlunoId) {
    ...
    public HistoricoAlunoDto getHistoricoFromAluno(Long alunoId) {
        ...
        if (!matriculasDoAluno.isEmpty()) {
            ...
            List<DisciplinaAlunoDto> disciplinasList = new ArrayList<>();
